...
Namespace TransparentEditorExample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class CustomersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCustomersRow(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String) As CustomersRow
				Dim rowCustomersRow As CustomersRow = (CType(Me.NewRow(), CustomersRow))
				Dim columnValuesArray() As Object = { CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax}
	...
	End Class
End Namespace
Namespace TransparentEditorExample.nwindDataSetTableAdapters
	...
	Partial Public Class CustomersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customers` (`CompanyName`, `ContactName`, `ContactTitle`, `Address`," & " `City`, `Region`, `PostalCode`, `Country`, `Phone`, `Fax`) VALUES (?, ?, ?, ?, " & "?, ?, ?, ?, ?, ?)"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode," & " Country, Phone, Fax FROM Customers"
		...
		Public Overridable Function Insert(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String) As Integer
